      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          {projects.map((project, index) => (
            <div 
              key={project.id}
              className={`bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 ${getColorClasses(project.color)} transition-all duration-500 transform hover:scale-105 hover:rotate-1 hover:shadow-2xl group`}
